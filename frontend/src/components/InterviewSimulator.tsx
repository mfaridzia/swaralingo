...
export const InterviewSimulator: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const SpeechRecognition =
      BrowserWin.SpeechRecognition || BrowserWin.webkitSpeechRecognition;
  ...
  const handleSendAnswer = () => {
    ...
    const fluency = Math.min(
      100,
      Math.max(65, 88 + (wordCount > 25 ? 5 : -5) - fillerCount * 3),
    );
    ...
    setTimeout(() => {
      ...
      if (nextIdx < recruiterQuestions.length) {
        ...
        // Wrap up
        const finalText =
          "Thank you! That completes our technical simulation panel. I will analyze your performance reports and update the recruiter bank profile.";
        setMessages((prev) => [
          ...prev,
          {
            id: `recruiter-end`,
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2 text-center flex flex-col items-center justify-center">
        <h1 className="text-3xl font-extrabold tracking-tight text-[#f4f4f5] flex items-center justify-center gap-3">
        ...
        <p className="text-sm text-[#a1a1aa] max-w-xl mx-auto">
          Simulate a real coding or systems design panel interview. Speak with
          Evelyn, our AI tech recruiter, to get detailed active flow analysis.
        </p>
      </div>
        ...
        <div className="glass-panel rounded-2xl p-8 space-y-6 max-w-2xl mx-auto border border-[#27272a]">
          ...
          <div className="text-center space-y-1.5">
            ...
            <p className="text-xs text-[#a1a1aa]">
              Select your target role and conversational style to start
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex flex-col space-y-2">
              ...
              >
                ...
                <option value="Backend System Architect">
            ...
            <div className="flex flex-col space-y-2">
              ...
              <select
                ...
                className="w-full bg-[#121214] border border-[#27272a] rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-[#22c55e] transition-colors cursor-pointer appearance-none"
              >
                <option value="Technical & System Design">
                  Technical & System Design Review
                </option>
                <option value="Behavioral Fit & Leadership">
                  Behavioral Fit & Leadership Questions
                </option>
                <option value="Coding Logic & Live Explainer">
                  Coding Logic & Live Explainer
                </option>
              </select>
            </div>
          </div>
          ...
          <div className="lg:col-span-4 space-y-6">
              ...
              <div className="border-t border-[#27272a] pt-4 space-y-3">
                ...
                <div className="flex justify-between items-center text-xs">
                  ...
                  <span className="font-bold text-[#22c55e]">
                    {Math.min(5, currentQuestionIdx + 1)} / 5 Questions
                  </span>
                </div>
                <div className="flex justify-between items-center text-xs">
            ...
            <div className="glass-panel rounded-2xl p-5 border border-[#27272a] space-y-4 bg-[#18181b]/20 text-xs">
              ...
              <p className="text-[#a1a1aa] leading-relaxed">
                Click the microphone to record your audio. Once completed, your
                response is transcribed and calculated for structural cohesion
                and filler rate.
              </p>
            </div>
          </div>
                        ...
                        <div className="flex items-center justify-between border-b border-[#27272a] pb-1.5">
                          ...
                          <div className="flex gap-3 font-semibold font-mono text-[10px]">
                            <span className="text-[#4ade80]">
                              Fluency: {msg.feedback.fluency}%
                            </span>
                            <span className="text-[#a1a1aa]">
                              Grammar: {msg.feedback.grammarScore}%
                            </span>
                            <span className="text-red-400">
                              Fillers: {msg.feedback.fillersCount}
                            </span>
                          </div>
                        </div>
                        <p className="text-[#a1a1aa] italic font-medium">
              ...
              <div className="border-t border-[#27272a] pt-4 space-y-3">
                  ...
                  <textarea
                    ...
                    placeholder={
                      isListening
                        ...
                        : "Type or speak your professional answer here..."
                    }
                ...
                {isListening && (
                  <div className="flex items-center justify-center gap-1.5 py-1">
                    ...
                    <span className="text-[10px] text-[#a1a1aa] font-semibold tracking-wider ml-1 uppercase">
                      Voice capturing streaming...
                    </span>
                  </div>
                )}
              </div>
